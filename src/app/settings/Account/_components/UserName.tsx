...
function UserName({setData,data}:{data?:any,setData:any}) {
  ...
  <div className='flex gap-6 items-center mt-8 w-full'>
                 <div className="first w-full">
                  ...
                  <input defaultValue={data?.userName} onChange={(x) => setData((e:any) => ({...e , userName:x.target.value}))} type="text" id='first' placeholder='Enter your UserName' className='  w-full mt-2 p-3 text-sm rounded-md border border-gray-300  dark:!bg-gray-800  dark:!border-gray-600 outline-0' />
                 </div>
